...
namespace ShopApp.WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View(new CartModel()
            {
                ...
                CartItems = cart.CartItems.Select(i => new CartItemModel()
                {
                    ...
                    To = i.Ticket.To,
                    From = i.Ticket.From,
                    Price = (decimal)i.Ticket.Price,
                    ImageUrl = i.Ticket.ImageUrl,
                    Quantity = i.Quantity
                }).ToList()
            });
        }
        ...
        [HttpPost]
        public IActionResult AddToCart(int ticketId,int quantity)
        {
            _cartService.AddToCart(_userManager.GetUserId(User), ticketId, quantity);
            return RedirectToAction("Index");
        }
        [HttpPost]
        public IActionResult DeleteFromCart(int ticketId)
        {
            _cartService.DeleteFromCart(_userManager.GetUserId(User), ticketId);
            return RedirectToAction("Index");
        }
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-LnRsIGb1nHtpFQmurdvHtFFyMILX8lS8";
            options.SecretKey = "sandbox-aN4OUHahz5tVEY8CnAuQwO91IXRClXvH";
            ...
            foreach (var item in model.CartModel.CartItems)
            {
                ...
                basketItem.Id = item.TicketId.ToString();
                basketItem.Name = item.To+" "+item.From;
                basketItem.Category1 = "Ucak Bileti";
